...
export default function SearchRoomDialog({
  trigger,
  onRoomSelect,
}: SearchRoomDialogProps) {
  ...
  const handleFileSelect = async (
    ...
    try {
      ...
      setOpen(false);
      navigate(`/room/${room.roomId}/file/${fileId}`);
        ...
        <div className="space-y-4">
                          ...
                          <CardHeader className="flex-1 pb-2 pl-4">
                            <div className="flex items-start justify-between w-full">
                              ...
                              <div className="flex items-center gap-2">
                                <Badge
                                  variant={
                                    room.password ? "secondary" : "default"
                                  }
                                >
                            ...
                            <div className="flex items-center gap-4 text-sm text-muted-foreground">
                              <div className="flex items-center gap-1">
                                ...
                                {getFileCount(room)} file
                                {getFileCount(room) !== 1 ? "s" : ""}
                              </div>
                              <div className="flex items-center gap-1">
          ...
          <div className="flex justify-between items-center pt-2 border-t">
            <p className="text-sm text-muted-foreground">
              {filteredRooms.length} of {rooms.length} room
              {rooms.length !== 1 ? "s" : ""}
            </p>
